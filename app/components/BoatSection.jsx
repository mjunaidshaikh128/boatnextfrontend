...
export default function BoatSection({ boats }) {
  return (
            ...
            >
              ...
              <div className="group relative">
                ...
                <p className="mt-5 line-clamp-3 text-sm leading-6 text-gray-600 px-2 font-bold underline">
                  ${boat.perDayCost} <span className="font-normal">per day</span>
                </p>
              </div>
              <div className="relative mt-8 flex items-center gap-x-4">
                {/* <img
                  src={boat.author.imageUrl}
                  alt=""
                  className="h-10 w-10 rounded-full bg-gray-50"
                /> */}
                {/* <div className="text-sm leading-6">
                  <p className="font-semibold text-gray-900">
                    <a href={boat.author.href}>
                      <span className="absolute inset-0" />
                      {boat.author.name}
                    </a>
                  </p>
                  <p className="text-gray-600">{boat.author.role}</p>
                </div> */}
              </div>
            </article>
          ))}
