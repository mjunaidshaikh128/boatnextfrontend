        ...
        <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
          <div className="bg-white py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              ...
              {/* Equipments */}
              <div className="mt-4 bg-slate-200 rounded-lg p-3 shadow-sm border border-slate-300">
                <h2 className="text-3xl font-semibold">Equipments</h2>
              ...
              <h2 className="text-3xl font-semibold mb-4">Booking Form</h2>
                ...
                <BookingForm boatBookings={boatBookings} boatId={params.boatid} perDayCost={boat.perDayCost} />
              </div>
